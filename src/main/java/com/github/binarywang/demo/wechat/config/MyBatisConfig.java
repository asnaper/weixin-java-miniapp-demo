...
public class MyBatisConfig {
    ...
    public SqlSessionFactoryBean sqlSessionFactory(DataSource dataSource) {
        ...
        // 设置别名包
        sqlSessionFactoryBean.setTypeAliasesPackage("package com.github.binarywang.demo.wechat.dao");
    ...
    public MapperScannerConfigurer mapperScannerConfigurer() {
        ...
        mapperScannerConfigurer.setBasePackage("com.github.binarywang.demo.wechat.dao");
